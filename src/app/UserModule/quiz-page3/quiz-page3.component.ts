...
@Component({
  ...
  styleUrls: ['./quiz-page3.component.css']
})
export class QuizPage3Component implements OnInit {
  ...
  getAllQuestions() {   
    ...
    console.log(`GetAllQuestions from Lev3: ${this.techName}`)
    this.questionService.getLev3QuestionJson(this.techName).subscribe(res => this.questionList = res.questions)
  }
